...
import '../../../cubit/auth/verify_register/verify_register_cubit.dart';
...
class _RegisterOtpPageState extends State<RegisterOtpPage> {
  ...
  void _verifyRegister() {
    if (_formKey.currentState?.validate() ?? false) {
      final entity = VerifyRegisterEntity(
        otpCode:
      ...
      final cubit = context.read<VerifyRegisterCubit>();
      cubit.verifyRegister(entity);
    }
  }
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            BlocConsumer<VerifyRegisterCubit, VerifyRegisterState>(
                              listener: (context, state) {
                                ...
                                } else if (state is VerifyRegisterError) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
